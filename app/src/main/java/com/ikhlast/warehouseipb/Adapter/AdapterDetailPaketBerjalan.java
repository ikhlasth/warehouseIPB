...
public class AdapterDetailPaketBerjalan extends RecyclerView.Adapter<AdapterDetailPaketBerjalan.ViewHolder> {
    ...
    public AdapterDetailPaketBerjalan(ArrayList<ModelPaket> barangs, Context ctx) {
        daftarPaket = barangs;
        context = ctx;
        listener = (DetailsBerjalan)ctx;
    }
