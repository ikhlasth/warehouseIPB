...
public class AdapterDetailBarangBerjalan extends RecyclerView.Adapter<AdapterDetailBarangBerjalan.ViewHolder> {
    ...
    public AdapterDetailBarangBerjalan(ArrayList<Barang> barangs, Context ctx) {
