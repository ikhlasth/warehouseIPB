...
public class AdapterDetailHewanBerjalan extends RecyclerView.Adapter<AdapterDetailHewanBerjalan.ViewHolder> {
    ...
    public AdapterDetailHewanBerjalan(ArrayList<Hewan> hewans, Context ctx) {
        daftarHewan = hewans;
        context = ctx;
